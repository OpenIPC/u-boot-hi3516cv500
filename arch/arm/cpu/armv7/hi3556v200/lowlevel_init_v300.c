...
#define hpm_formula(hpm, temp) ((hpm) + 6 + ((((temp) - 70) * 205) >> 10))
...
#define VMIN_CORE_56V200 840000
#define VMAX_CORE_56V200 1030000
#define Y_56V200 1337969
...
void start_svb(void)
{
	...
	if (chip_id == CHIP_3516DV300)
		tmp_reg = (tmp_reg & 0xff00ffff) | (SVB_VER_16DV300 << 16); /* get low 16 bits */
	else if (chip_id == CHIP_3516C500)
		tmp_reg = (tmp_reg & 0xff00ffff) | (SVB_VER_16CV500 << 16); /* get low 16 bits */
	else if (chip_id == CHIP_3559V200)
		tmp_reg = (tmp_reg & 0xff00ffff) | (SVB_VER_59V200 << 16); /* get low 16 bits */
	else if (chip_id == CHIP_3556V200)
		tmp_reg = (tmp_reg & 0xff00ffff) | (SVB_VER_56V200 << 16); /* get low 16 bits */
