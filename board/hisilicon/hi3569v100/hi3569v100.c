...
static struct mm_region hi3569v100_mem_map[] = {
	{
		.virt = 0x0UL,
		.phys = 0x0UL,
		.size = 0x40000000UL,
...
struct mm_region *mem_map = hi3569v100_mem_map;
...
int do_ugzip(cmd_tbl_t *cmdtp, int flag, int argc, char *const argv[])
{
	...
	ret = hw_dec_decompress((unsigned char *)(uintptr_t)((dst >> 32) & 0xffffffff),
			(unsigned char *)(uintptr_t)(dst & 0xffffffff),&size_uncomparessed, (unsigned char *)(uintptr_t)(src >> 32),
