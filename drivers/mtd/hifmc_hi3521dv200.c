...
static void hi3521dv200_io_config_spi_sfc(void)
{
    /* set pad ctrl reg for spi */
    writel(0xd0, REG_IO_BASE_FMC + SFC_MOSI_IO_0_REG);    /* sfc_mosi_io0 */
    writel(0xd0, REG_IO_BASE_FMC + SFC_WP_IO_2_REG);      /* sfc_wp_io2 */
    writel(0x2b0, REG_IO_BASE_FMC + SFC_CLK_REG);		  /* sfc_clk */
    writel(0xd0, REG_IO_BASE_FMC + SFC_MISO_IO_1_REG);    /* sfc_miso_io1 */
    writel(0xd0, REG_IO_BASE_FMC + SFC_HOLD_IO_3_REG);    /* sfc_hold_io3 */
