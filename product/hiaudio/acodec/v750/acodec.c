...
int acodec_device_init(void)
{
	...
	// audio crg
	acodec_regsetbit(1, 1, (unsigned long)((hi_uintptr_t)g_acodec_crg_reg));
	acodec_regsetbit(1, 2, (unsigned long)((hi_uintptr_t)g_acodec_crg_reg));
...
int acodec_device_exit(void)
{
	...
	// audio crg
	acodec_regsetbit(0, 1, (unsigned long)((hi_uintptr_t)g_acodec_crg_reg));
	acodec_regsetbit(0, 2, (unsigned long)((hi_uintptr_t)g_acodec_crg_reg));
