...
int acodec_device_init(void)
{
	...
	acodec_RegWrite32(0x2 << 30, 0x3 << 30, (unsigned long)((hi_uintptr_t)g_acodec_crg_reg));
	acodec_regsetbit(1, 29, (unsigned long)((hi_uintptr_t)g_acodec_crg_reg));
    acodec_regsetbit(0, 28, (unsigned long)((hi_uintptr_t)g_acodec_crg_reg));
...
{  
    ...
    acodec_regsetbit(0, 0, (unsigned long)((hi_uintptr_t)g_acodec_crg_reg));
